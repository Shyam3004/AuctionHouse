...
<div class="main">
  ...
  <div class="body">
    <div class="body_resize">
      <div class="left">
        <form id="form1" name="form1" method="post" action="AdminLogin2">
           <table width="384" height="186" border="0" bordercolor="#666666">
             <tbody>
               <tr>
                 <td height="52" colspan="2" bgcolor="#F1F1F1"><div align="center" class="style12"><span class="style22">Admin Login</span></div></td>
               </tr>
               <tr>
