...
%></p>
              <p><%	try
	{
		...
		ResultSet rs2=st2.executeQuery("select im.itemid,im.catid,im.itemname,im.startprice,im.enddate,im.seller,bi.bidderid,bi.bamt from item_master im,bidding_info bi where bi.bidderid='"+request.getParameter("theuser")+"' and bi.status=1 and im.itemid=bi.itemid group by itemid");
